...
// Adding new contact
    public void addNotepad(Notepad notepad) {
        ...
        values.put(KEY_TITLE, notepad.getTitle()); // Note Tile
        values.put(KEY_CONTENT, notepad.getContent()); // Note Content
    ...
    public List<Notepad> getAllNotes() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                notepad.setContent(cursor.getString(2));
                // Adding note to list
...
// Getting Notepad Count
    public int getNotepadCount() {
...
// Updating single note
    public int updateNote(Notepad notepad) {
        ...
        ContentValues values = new ContentValues();
        values.put(KEY_TITLE, notepad.getTitle());
        values.put(KEY_CONTENT, notepad.getContent());
